var __webpack_modules__ = {
    ...
    4147: module => {
        "use strict";
        module.exports = JSON.parse('{"name":"@jsii/runtime","version":"1.44.2","description":"jsii runtime kernel process","license":"Apache-2.0","author":{"name":"Amazon Web Services","url":"https://aws.amazon.com"},"homepage":"https://github.com/aws/jsii","bugs":{"url":"https://github.com/aws/jsii/issues"},"repository":{"type":"git","url":"https://github.com/aws/jsii.git","directory":"packages/@jsii/runtime"},"engines":{"node":">= 12.7.0"},"main":"lib/index.js","types":"lib/index.d.ts","bin":{"jsii-runtime":"bin/jsii-runtime"},"scripts":{"build":"tsc --build && chmod +x bin/jsii-runtime && npx webpack-cli && npm run lint","watch":"tsc --build -w","lint":"eslint . --ext .js,.ts --ignore-path=.gitignore --ignore-pattern=webpack.config.js","lint:fix":"yarn lint --fix","test":"jest","test:update":"jest -u","package":"package-js"},"dependencies":{"@jsii/kernel":"^1.44.2","@jsii/check-node":"1.44.2","@jsii/spec":"^1.44.2"},"devDependencies":{"@scope/jsii-calc-base":"^1.44.2","@scope/jsii-calc-lib":"^1.44.2","@types/jest":"^27.0.2","@types/node":"^12.20.28","eslint":"^7.32.0","jest":"^27.2.4","jsii-build-tools":"^1.44.2","jsii-calc":"^3.20.120","prettier":"^2.4.1","source-map-loader":"^3.0.0","ts-jest":"^27.0.5","typescript":"~3.9.10","webpack":"^5.57.1","webpack-cli":"^4.8.0"}}');
    },
    9402: module => {
        "use strict";
